...
const HeroSection = () => {
  return (
    <section className="bg-white text-center py-12">
      <div className="container mx-auto px-4 grid grid-cols-12 gap-4 mb-20">
        {/* Hero Text Section */}
      ...
      <div className="container mx-auto mt-12">
        <div className="bg-blue-600 text-white py-6 rounded-lg col-span-12">
      ...
      <div className="container mx-auto mt-8 grid grid-cols-12 gap-4 text-center">
        <div className="col-span-12 md:col-span-3 bg-white shadow-lg rounded-lg py-6">
          <h3 className="text-2xl font-bold text-blue-600">Deployed nodes</h3>
          <p className="text-3xl mt-2 font-semibold">114</p>
        </div>
        <div className="col-span-12 md:col-span-3 bg-white shadow-lg rounded-lg py-6">
          <h3 className="text-2xl font-bold text-blue-600">Networks</h3>
